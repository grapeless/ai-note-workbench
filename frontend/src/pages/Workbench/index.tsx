...
import {Brain, ChevronRight, Settings2, TriangleAlert} from "lucide-react"
...
import {CollectionSidebar} from "@/pages/Workbench/components/CollectionSidebar"
                                ...
                                <SidebarMenu className="gap-4 px-3 pb-5">
                                    ...
                                    <Collapsible open={settingsOpen} onOpenChange={setSettingsOpen}
                                        ...
                                        <div className={cn(
                                            ...
                                            "grid grid-cols-[minmax(0,1fr)_3.5rem] p-0",
                                        )}>
                                            <CollapsibleTrigger
                                                render={
                                                    <button
                                            ...
                                            >
                                                <Settings2 strokeWidth={1.75} className="size-5! shrink-0 text-workbench-primary"
                                                           aria-hidden="true"/>
                                                <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                                                    <span className="text-[13px] font-black tracking-[0.13em]">SETTINGS</span>
                                        ...
                                        <CollapsibleContent>
                                            <SidebarMenuSub className="mx-0 mt-2 translate-x-0 gap-2 border-y border-l-0 border-ink/15 bg-paper/85 px-3 py-3">
                                                <SidebarMenuSubItem>
                                                    <SidebarMenuSubButton
